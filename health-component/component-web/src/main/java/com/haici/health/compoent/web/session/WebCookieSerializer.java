 ...
 */
@Slf4j
public class WebCookieSerializer implements CookieSerializer {
    ...
    public List<String> readCookieValues(HttpServletRequest request) {
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (this.getCookieName(request).equals(cookie.getName())) {
    ...
    public void writeCookieValue(CookieValue cookieValue) {
        ...
        sb.append(this.getCookieName(request)).append('=');
    ...
    public String getCookieName(HttpServletRequest request) {
        if (createBy != null) {
            StringBuilder cookiesName = new StringBuilder(100);
            cookiesName.append(this.name);
            ...
            for (String paramName : createByList) {
                ...
                if (StringUtils.isBlank(tmp)) {
                    ...
                    cookiesName.append("_").append(tmp);
                }
            }
            log.debug("cookie name:" + cookiesName.toString());
