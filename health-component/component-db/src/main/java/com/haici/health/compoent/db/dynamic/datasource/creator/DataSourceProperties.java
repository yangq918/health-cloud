...
import com.haici.health.compoent.db.dynamic.datasource.creator.shardingjdbc.ShardingjdbcConfig;
...
public class DataSourceProperties {
    ...
    /**
     * 连接池类型，如果不设置自动查找 Druid
     */
    private String type = DataSourceCreatorType.DRUID.getCode();
    /**
     * JDBC driver
     */
    ...
    @NestedConfigurationProperty
    private ShardingjdbcConfig shardingjdbc = new ShardingjdbcConfig();
        ...
        if (StringUtils.hasText(cipherText)) {
            ...
            if (matcher.find()) {
                try {
                    ...
                    log.error("DataSourceProperties.decrypt error ", e);
                }
            }
        }
        return cipherText;
